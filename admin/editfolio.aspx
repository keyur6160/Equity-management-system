<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="editfolio.aspx.cs" Inherits="admin_Default" %>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-4 text-uppercase">Edit Folio</h5>
                                    <hr>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <i class="fa fa-calculator"></i>
                                                                ...
                                                                <%-- <input type="text" class="form-control" id="folioname" />--%>
                                                                <asp:TextBox ID="txt_folioname" class="form-control" runat="server"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <asp:DropDownList ID="firstperson" class="form-control" runat="server" DataSourceID="SqlDataSource1" DataTextField="holdername"></asp:DropDownList>
                                                        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:StockMarketDBConnectionString2 %>' ProviderName='<%$ ConnectionStrings:StockMarketDBConnectionString2.ProviderName %>' SelectCommand="SELECT * FROM [holder] WHERE ([userid] = @userid)">
                                                            <SelectParameters>
                                            ...
                                            <div class="mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <asp:SqlDataSource runat="server" ID="SqlDataSource2" ConnectionString='<%$ ConnectionStrings:StockMarketDBConnectionString2 %>' ProviderName='<%$ ConnectionStrings:StockMarketDBConnectionString2.ProviderName %>' SelectCommand="SELECT * FROM [holder] WHERE ([userid] = @userid)">
                                                            <SelectParameters>
                                                                <asp:SessionParameter SessionField="userid" Name="userid" Type="Int32"></asp:SessionParameter>
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
                                            ...
                                            <div class="mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <asp:SqlDataSource runat="server" ID="SqlDataSource3" ConnectionString='<%$ ConnectionStrings:StockMarketDBConnectionString2 %>' ProviderName='<%$ ConnectionStrings:StockMarketDBConnectionString2.ProviderName %>' SelectCommand="SELECT * FROM [holder] WHERE ([userid] = @userid)">
                                                            <SelectParameters>
                                                                <asp:SessionParameter SessionField="userid" Name="userid" Type="Int32"></asp:SessionParameter>
                                                            </SelectParameters>
                                                        </asp:SqlDataSource>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <%--<asp:Button ID="btn_edit" class="btn btn-primary mt-2" runat="server" Text="edit folio" OnClick="btn_folio_Click" />--%>
                                        <asp:Button ID="btnedit"  class="btn btn-primary mt-2" runat="server" Text="edit folio" OnClick="btnedit_Click" />
                                    </div>
                                            ...
                                            <div class="box">
                                                <div class="box-body">
                                                    <div class="table-responsive">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:StockMarketDBConnectionString2 %>" SelectCommand="SELECT [folioid], [folioname], [firstholdername], [secondholdername], [thirdholdername] FROM [foliomaster] where ([userid] = @userid)">
                                                               <SelectParameters>
