<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="holder.aspx.cs" Inherits="admin_Default2" %>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card text-center">
                                <div class="card-body">
                                    ...
                                    <h5 class="mb-4 text-uppercase">Create Holder</h5>
                                    <hr>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="text-center">
                                                ...
                                                <asp:Button ID="btn_cancel" class="btn btn-primary-light mt-2" runat="server" Text="Cancel" OnClick="btn_cancel_Click" />
                                                <asp:Button ID="btn_add" runat="server" class="btn btn-primary-light mt-2" Text="Submit" OnClick="btn_add_Click" />
                                            </div>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
